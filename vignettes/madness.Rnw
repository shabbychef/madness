...
%\VignetteIndexEntry{Using the madness Package}
%\VignetteKeyword{Finance}
%\VignetteKeyword{madness}
%\VignettePackage{madness}
...
\newcommand{\madness}{\CRANpkg{madness}\xspace}
...
opts_chunk$set(cache=TRUE,cache.path="cache/madness")

#opts_chunk$set(fig.path="figure/",dev=c("pdf","cairo_ps"))
opts_chunk$set(fig.path="figure/madness",dev=c("pdf"))
...
\title{Using the \pkg{madness} package}
...
%Example computations via the \madness package are illustrated.
Example computations via the madness package are illustrated.
\end{abstract}%UNFOLD
